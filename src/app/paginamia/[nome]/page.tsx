...
export default function SearchBar() {
  ...
  params.set('guests', guest.toString());
  params.set('rooms', stanze.toString());
  params.set('bathrooms', bagni.toString());
  
  window.location.href = `/?${params.toString()}`;
  }
  const modalContainerClass = "bg-white p-6 rounded-lg shadow-lg relative w-[500px]";
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg relative w-[500px] ">
            ...
            <div className="pt-4">
              <div>
                ...
                <p className="text-gray-500 text-sm pt-1">Find your perfect place!
                </p>
              </div>
              ...
              <div className="text-sm pt-5 flex justify-between items-center">
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-600">How many guests are coming?
                  </p>
                </div>
                <div className="flex justify-between items-center gap-3">
                  
                  <button className=" w-10   h-10   rounded-full   border-[1px]   border-neutral-400   flex   items-center   justify-center   text-neutral-600   cursor-pointer   hover:opacity-80   transition " onClick={()=> setGuest(guest + 1)}>+</button>
                
                  <p>{guest}</p>
                  
                  <button className=" w-10   h-10   rounded-full   border-[1px]   border-neutral-400   flex   items-center   justify-center   text-neutral-600   cursor-pointer   hover:opacity-80   transition " onClick={()=> {setGuest(guest - 1)
              ...
              <div className="text-sm pt-5 flex justify-between items-center">
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-600">How many rooms do you need?
                  </p>
                </div>
                <div className="flex justify-between items-center gap-3">
                  
                  <button className=" w-10   h-10   rounded-full   border-[1px]   border-neutral-400   flex   items-center   justify-center   text-neutral-600   cursor-pointer   hover:opacity-80   transition " onClick={()=> setStanze(stanze + 1)}>+</button>
                
                  <p>{stanze}</p>
                  
                  <button className=" w-10   h-10   rounded-full   border-[1px]   border-neutral-400   flex   items-center   justify-center   text-neutral-600   cursor-pointer   hover:opacity-80   transition " onClick={()=> {setStanze(stanze - 1)
                  if(stanze<= 1) setStanze(1)
                  }
                  }>-</button>
              ...
              <div className="text-sm pt-5 flex justify-between items-center">
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-600">How many bahtrooms do you need?
                  </p>
                </div>
                <div className="flex justify-between items-center gap-3">
                  
                  <button className=" w-10   h-10   rounded-full   border-[1px]   border-neutral-400   flex   items-center   justify-center   text-neutral-600   cursor-pointer   hover:opacity-80   transition " onClick={()=> setBagni(bagni + 1)}>+</button>
                
                  <p>{bagni}</p>
                  
                  <button className=" w-10   h-10   rounded-full   border-[1px]   border-neutral-400   flex   items-center   justify-center   text-neutral-600   cursor-pointer   hover:opacity-80   transition " onClick={()=> {setBagni(bagni - 1)
                  if(bagni<= 1) setBagni(1)
                  }
                  }>-</button>
